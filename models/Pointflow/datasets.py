...
class ShapeNet15kPointClouds(Uniform15KPC):
    def __init__(self, root_dir="data/ShapeNetCore.v2.PC15k",
                 categories=['newcar'], tr_sample_size=2048, te_sample_size=2048,
                 split='train', scale=1., normalize_per_shape=True,
                 normalize_std_per_axis=False,
                 random_subsample=False,
                 all_points_mean=None, all_points_std=None):
        self.root_dir = root_dir
...
if __name__ == "__main__":
    shape_ds = ShapeNet15kPointClouds(categories=['newcar'], split='val')
